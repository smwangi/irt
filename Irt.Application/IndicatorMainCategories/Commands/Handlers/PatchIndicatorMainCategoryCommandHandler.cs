...
internal sealed class PatchIndicatorMainCategoryCommandHandler(
    ...
    IMapper mapper)
    : ICommandHandler<PatchIndicatorMainCategoryCommand, Result<IndicatorMainCategoryDto>>
{
    public async Task<Result<IndicatorMainCategoryDto>> HandleAsync(
        PatchIndicatorMainCategoryCommand command,
