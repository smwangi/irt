...
internal sealed class UpdateIndicatorCategoryCommandHandler(
    ...
    IMapper mapper)
    : ICommandHandler<UpdateIndicatorCategoryCommand, Result<IndicatorCategoryDto>>
{
    public async Task<Result<IndicatorCategoryDto>> HandleAsync(
        UpdateIndicatorCategoryCommand command,
